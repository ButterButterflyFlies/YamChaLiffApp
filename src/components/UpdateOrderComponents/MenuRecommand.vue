...
export default {
  ...
  computed: {
    isLoading() { return this.menuList.length > 0 }
  },
  methods: {
    openPage (product) { this.$emit('select', product) },
  }
